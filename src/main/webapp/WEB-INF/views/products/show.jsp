	...
	<article id="${product.title}" itemscope
		...
		<div class="container">
			...
			<section class="data product-detail">
				...
				<p>
					Numero de paginas: <span itemprop="numberOfPages">${product.pages}</span>
				</p>
	...
	<footer id="layout-footer">
		<div class="clearfix container">
			...
			<div id="newsletter-footer">
				<!-- social-footer -->
				<p class="footer-title">Receba as Novidades e Lancamentos</p>
				<div id="form-newsletter">
					...
					<ul>
						<li class="ie8"><a
							...
							rel="nofollow">Receba as Novidades e Lancamentos</a></li>
					</ul>
				</div>
